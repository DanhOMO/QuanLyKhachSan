...
public class InHoaDon extends javax.swing.JFrame {
    ...
    public static void main(String[] args) {
        ...
        HoaDon temp =hdDao.timHoaDon("HD00000001-001");
        
        InHoaDon a = new InHoaDon(temp);
        a.setVisible(true);
    ...
    // End of variables declaration//GEN-END:variables
        ...
        for (LichSuDatPhong lichSuDatPhong : ds) {
            LoaiPhong lp = lpDao.timTheoMa(lichSuDatPhong.getPhong().getLoaiPhong().getMaLoaiPhong());
